...
const CartItem: React.FC<CartItemPropsType> = ({ id, title, imageUrl, size, price, count, type, }) => {
    ...
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button
          ...
          onClick={onClickMinus} className={clsx('button button--outline button--circle cart__item-count-minus', {'cart__item-count-minus--disabled' : count === 1})}>
